...
public class RedNear extends OpMode {
    ...
    public void init() {
        ...
        paths = follower
                ...
                //shoot1 == 0
                .addPath(
                        new BezierLine(new Pose(110.000, 135.000), new Pose(79.000, 80.000))
                )
                .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(225))
                //align1 == 1
                .addPath(
                        new BezierLine(new Pose(79.000, 70.000), new Pose(89.000, 80.000))
                )
...
//                //openGate1 == 3
//                .addPath(
//                        new BezierLine(new Pose(127.000, 83.789), new Pose(123.000, 74.000))
//                )
//                .setConstantHeadingInterpolation(Math.toRadians(0))
//                //openGate2 == 4
//                .addPath(
//                        new BezierLine(new Pose(123.000, 74.000), new Pose(125.000, 74.000))
//                )
//                .setConstantHeadingInterpolation(Math.toRadians(0))
                //shoot2 == 3
                .addPath(
                        new BezierLine(new Pose(128.500, 80.00), new Pose(79.000, 80.000))
                )
                .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(225))
                //align2 == 4
                .addPath(
                        new BezierLine(new Pose(79.000, 80.000), new Pose(89.000, 55.000))
                )
                .setLinearHeadingInterpolation(Math.toRadians(225), Math.toRadians(0))
                //collect2 == 5
                .addPath(
                ...
                //shoot3 == 6
                .addPath(
                        new BezierLine(new Pose(128.000, 55.000), new Pose(79.000, 80.000))
                )
                .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(225))
                //align3 == 7
                .addPath(
