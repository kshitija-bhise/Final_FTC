...
//                   //align2 == 4
                .addPath(
                        new BezierLine(new Pose(66.000, 18.000), new Pose(55.000, 62.000))
                )
                .setLinearHeadingInterpolation(Math.toRadians(285), Math.toRadians(180))
                //collect2 == 5
                .addPath(
                        new BezierLine(new Pose(55.000, 62.000), new Pose(17.000, 62.000))
                )
                .setConstantHeadingInterpolation(Math.toRadians(180))
//               //shoot3 == 6
                .addPath(
                ...
                //align1 == 7
                .addPath(
                        new BezierLine(new Pose(58.000, 90.000), new Pose(48.000, 86.000))
                )
                .setLinearHeadingInterpolation(Math.toRadians(315), Math.toRadians(180))
                //Collect1 == 8
                .addPath(
                        new BezierLine(new Pose(48.000, 86.000), new Pose(20.000, 86.000))
                )
                .setConstantHeadingInterpolation(Math.toRadians(180))
                //shoot2 == 9
                .addPath(
                        new BezierLine(new Pose(20.000, 86.000), new Pose(58.000, 90.000))
                )
                .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(315))
                //park == 10
                .addPath(
