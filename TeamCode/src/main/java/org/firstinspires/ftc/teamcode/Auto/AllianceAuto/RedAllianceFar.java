...
@Autonomous
@Configurable // Panels
public class RedAllianceFar extends OpMode {
    ...
    public void init() {
        ...
        paths = follower
                ...
                //classifier == 4
                .addPath(
                        new BezierLine(new Pose(82, 18), new Pose(139, 30)
                        )
                ).setLinearHeadingInterpolation(Math.toRadians(248), Math.toRadians(90))

                //collection == 5
                .addPath(
                        new BezierLine(new Pose(139, 30), new Pose(139, 50)
                        )
                ).setConstantHeadingInterpolation(Math.toRadians(90))
//
                //shoot == 6
                .addPath(
                        new BezierLine(new Pose(132, 60), new Pose(82, 18)
                        )
                ).setLinearHeadingInterpolation(Math.toRadians(90),Math.toRadians(248))

                //park == 10
                .addPath(
                        new BezierLine(new Pose(82.000, 18.000), new Pose(120.000, 30.000))
                )
                .setLinearHeadingInterpolation(Math.toRadians(248), Math.toRadians(90))
